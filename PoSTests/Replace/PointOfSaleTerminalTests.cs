namespace PoSTests.Replace
{
    ...
    public class PointOfSaleTerminalTests
    {
        ...
        [TestMethod]
        public void VerifyTotalPrice_ExtPriceWithReplace_ABCD()
        {
        ...
        [TestMethod]
        public void VerifyTotalPrice_ExtPriceWithReplace_CCCCCCC()
        {
            this.terminal = new PointOfSaleTerminal();
        ...
        [TestMethod]
        public void VerifyTotalPrice_ExtPriceWithReplace_ABCDABA()
        {
            this.terminal = new PointOfSaleTerminal();
